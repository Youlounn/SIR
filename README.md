...
Un ensemble de classes représentant le DAO ont été implémentées :
*Allergie
*Date
...
Une API REST a été mise en place, afin de pouvoir lui demander des données, modifier les données existantes, ou en supprimer.
...
*/users/sondageCrea/{id}, GET : id = l'id d'un sondage, retourne le createur d'un sondage
